...
//use HDNET\Importr\Utility;
    ...
    * EduardFekete;BestPW123;3;Fekete;Eduard; Example 21; +049123456789;eduard.fekete@mbconnectline.de;91550;Feuchtwangen;MB Connect Line GmbH
    * HansVader;1234;3;Vader;Hans; Example 22; +049123456710;hans_vader@universe.com;99900;Universe;Hollywood Studios
    *
    * ------------------------------------------------------------------------------------------------
    *
...
class InsertUpdateTable extends AbstractTarget implements TargetInterface
{
    ...
    */
    public function updateRecord(array $entry)
    {
        ...
        $GLOBALS['TYPO3_DB']->exec_UPDATEquery($into_table, $whereStatement, $field_values);
